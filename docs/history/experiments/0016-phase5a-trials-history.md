# 0016 history — Phase 5A semantic-delta-extraction validation status, Trials 1-4

**Historical record, moved out of the main ADR reading path.** Full
architecture/decision context: `docs/decisions/0016-phase5-persona-evidence-utility-validation.md`
(Decision/Why/Academic basis/Pre-declared acceptance criteria/Alternatives/
Known limitations). This file preserves the full validation-status snapshot
and the real Trial 1/2/3/3-addendum/4-planning results verbatim, for
provenance.

**Where this history now leads:** Trial 3's frozen zero-shot baseline and
Trial 4's planning section below were superseded by Phase 5A Trial 4 / Test 1,
which is now CLOSED — SUCCESS. See
`training/phase5a/benchmark/test1-final-result.md` for the authoritative
current result, and `docs/history/experiments/0017-trial4-implementation-journal.md`
for Trial 4's own implementation/addenda history.
...
`docs/history/experiments/manual-mvp-validation.md`'s Phase 5A section for the exact
...
grading table live in `docs/history/experiments/manual-mvp-validation.md`'s
...
5. Record the real result in this section and in
   `docs/history/experiments/manual-mvp-validation.md`'s Trial 1 subsection,
...
7. Record the real result in this section and in
   `docs/history/experiments/manual-mvp-validation.md`'s Trial 2 subsection,
...
See `docs/history/experiments/manual-mvp-validation.md`'s "Trial 3" subsection for
