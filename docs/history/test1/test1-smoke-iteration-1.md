...
**Superseded as Test 1's answer by
`training/phase5a/benchmark/test1-final-result.md`** (a separate, later
10-case round) — this smoke round remains documented here, moved to
`docs/history/test1/` as historical/debug material, unedited, never as
the final Test 1 result.
